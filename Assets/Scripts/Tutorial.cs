...
public class Tutorial
{
    ...
    public static readonly Step[] STEPS =
    {
        ...
        new Step("hud", "Ship and world", "The band along the bottom: SHIP is your hull, shield, fuel and hold. FLIGHT is your speed and thrust, and the way back to the cargo ship. TARGET is whatever you are looking at or locked on, and the weapon in hand.", null, false, "status", "readout"),
        ...
        new Step("refit", "Upgrades", "The hangar window's Ship upgrades tab lists your upgrades: laser, engine, tank, cargo, scanner, hull. A bigger hold and a stronger laser pay for themselves fastest.", null, false, "refits"),
        ...
        new Step("done", "Tutorial complete", "That is the loop: fill the hold, stow it, warp to the Hub, sell, upgrade, repeat. Vega out. Good hunting.", null, true),
    };
