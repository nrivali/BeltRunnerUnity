...
public class Tutorial
{
    ...
    public static readonly Step[] STEPS =
    {
        ...
        new Step("refit", "Refits", "The hangar window's Ship refits tab lists your refits: laser, engine, tank, cargo, scanner, hull. A bigger hold and a stronger laser pay for themselves fastest.", null, false, "refits"),
