...
public class Menu
{
    ...
    static readonly object[][] CONTROLS =
    {
        ...
        new object[] { new[] { "F" }, "Testing: in the combat test F opens the refit panel anywhere, credits are bottomless, and each refit row has a − button that takes a level off, so any loadout can be tried." },
