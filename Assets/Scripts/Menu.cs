...
public class Menu
{
    ...
    static readonly object[][] CONTROLS =
    {
        ...
        new object[] { "Raiders", "Pirate raiders hold station off the rich pockets (the KP fields) and attack within 3,250 m. Roll the scroll wheel to select the autocannon (fitted from the start; the refits sharpen it) and hold LMB: bolts go straight down the nose, where the crosshair is. Q locks a raider, which puts an amber LEAD pip where a bolt fired now would meet it: fly the crosshair onto the pip. A raider lock only tracks; the ship steers itself onto rocks and the cargo ship only. The cargo ship's guns cover 4,500 m round it. Lose the hull to them and they strip a third of your hold before recovery." },
