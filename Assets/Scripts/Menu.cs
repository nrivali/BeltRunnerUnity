...
public class Menu
{
    ...
    static readonly object[][] CONTROLS =
    {
        ...
        new object[] { "Raiders", "Pirate raiders hold station off the rich pockets (the KP fields) and attack within 3,250 m. Put the nose on one and hold LMB to fire the autocannon (fitted from the start; the refits sharpen it); Q locks one so the ship keeps its nose on it. The cargo ship's guns cover 4,500 m round it. Lose the hull to them and they strip a third of your hold before recovery." },
