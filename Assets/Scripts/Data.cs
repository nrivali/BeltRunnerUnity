...
public static class Data
{
    ...
    public static readonly Dictionary<string, Upgrade> UPGRADES = new Dictionary<string, Upgrade>
    {
        ...
        { "gun", new Upgrade { name = "Autocannon", levels = new[] { L(rate: 6, reach: 1800, mult: 8), L(rate: 7, reach: 2200, mult: 12), L(rate: 8, reach: 2800, mult: 18), L(rate: 10, reach: 3400, mult: 26) }, costs = new float[] { 900, 3200, 9000 } } },
    };
