...
$VOICE='XrExE9yKIg1WjnnlVkGX'   # Matilda: knowledgeable, professional; the voice of Vega
$lines=[ordered]@{
  ...
  hud    = "Bottom centre is your ship: hull, fuel, speed, thrust and cargo. Top right is the world: zone, laser, radar, and whatever you are looking at."
