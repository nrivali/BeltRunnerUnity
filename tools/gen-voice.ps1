...
$lines=[ordered]@{
  launch  = "Vega here. Press Shift on the pad. Approach control taxis you out; the ship is yours when it lets go."
  ...
  return  = "Follow the CARGO SHIP readout. Within 2,250 press H and approach control brings you in."
  stow    = "Press H to move your ore into the cargo ship storage. The pad refuels you and mends the hull while you sit on it."
  hub     = "Nothing sells out here. Press N and warp to the Hub to sell and upgrade."
  depart  = "Press Depart, or Shift on the pad, to launch."
