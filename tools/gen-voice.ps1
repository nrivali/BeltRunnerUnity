...
$lines=[ordered]@{
  ...
  hud    = "The band along the bottom: SHIP is your hull, shield and fuel. FLIGHT is your speed and thrust, and the way back to the cargo ship. TARGET is whatever you are looking at or locked on, and the weapon in hand. CARGO is the hold."
