...
$lines=[ordered]@{
  launch  = "Vega here. Press W on the pad. Approach control taxis you out; the ship is yours when it lets go."
  steer   = "The mouse steers. W and S work the throttle, A and D roll, X cuts the throttle. Open up and give me a turn."
  ...
  lock    = "Put the mouse on a copper rock, orange veins, and press Q to lock it."
  mine    = "Get within laser reach and hold the left mouse button. When the rock breaks, fly through the glow to collect."
  weapons = "2 is the autocannon, 3 the seeker rockets, 1 the mining laser. The wheel cycles them. Try one."
  combat  = "Raiders hold the rich pockets. Lock one with Q and fire; a rocket chases it on its own. Your shield soaks hits and recharges once they stop."
  return  = "Follow the CARGO SHIP readout. Within 2,250 press E and approach control brings you in."
  ...
  depart  = "Press Depart, or W on the pad, to launch."
