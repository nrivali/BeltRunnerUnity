...
| Fires when | Trigger held (LMB or L), straight down the nose like the laser; the mouse steers the nose onto the LEAD pip | Nose within 25° of the ship and inside gun reach; rough aim: 0.09 spread (~5°) and the lead over- or under-estimated by 55–115% shot by shot |
