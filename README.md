...
| The deep-space backdrop (2026-09-15): the sky shader draws three domain-warped coloured nebula clouds in their own parts of the sky (the zone's two nebula colours and a burnt orange), and a denser star field with a few bright coloured stars; all subtle (the clouds at 0.3 to 0.4; a galaxy band was tried and dropped as too much) and under the bloom threshold, so space still reads black and the sun stays the brightest thing | `Assets/Resources/Shaders/Sky.shader` | new |
