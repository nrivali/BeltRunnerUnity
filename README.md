...
| The player runs full screen: borderless at the desktop resolution (`FullScreenMode.FullScreenWindow` in `Build.cs` and the project settings); Alt+Enter drops it to a window and back, and the smoke runs pass `-screen-fullscreen 0` to stay a 1280×720 window |  |  |
