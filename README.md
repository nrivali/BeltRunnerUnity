...
| The sun as the user's concept frame has it (2026-09-15): compact and near white (#fff1e2, disc 0.0085 rad) with a tight hot core and a small halo, no wide wash; a lens flare of three faint cool-tinted ghosts of the sun mirrored through the frame's centre in the post composite; the god rays at gain 0.4 and the dust thinner (0.00002, gain 0.3) | `Assets/Scripts/Lighting.cs`, `Sky.shader`, `Post.shader` | new |
...
| The sun and sky as the user's sunrise reference has them (2026-09-15): a black sky of dense small white stars with only a trace of nebula, a white-hot disc (0.011 rad) in a broad soft orange glow that falls away a long way out (three terms, 1.1 / 0.32 / 0.09 of the disc radius), and a warm gold key light (#ffd3a4, 6.0) | `Assets/Resources/Shaders/Sky.shader`, `Assets/Scripts/Lighting.cs` | new |
