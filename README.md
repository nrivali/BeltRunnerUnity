...
| The deep-space backdrop (2026-09-15): the sky shader draws a galaxy band tilted off the belt plane (cloud structure along it, dark dust lanes through its middle, warm white in the core and bluer at the edges), three domain-warped coloured nebula clouds in their own parts of the sky (the zone's two nebula colours and a burnt orange), and a denser star field with a few bright coloured stars, denser in the band; all subtle (the band at 0.16, the clouds at 0.3 to 0.4) and under the bloom threshold, so space still reads black and the sun stays the brightest thing | `Assets/Resources/Shaders/Sky.shader` | new |
