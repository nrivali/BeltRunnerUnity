...
| The window keeps clear of the tutorial card (it sits below the card while the card shows) and of the status pane along the bottom; the smoke run shows it without the ease so its screenshots catch it |  |  |
