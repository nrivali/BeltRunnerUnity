...
| Coasting: the zero-throttle drag is 0.64/s (the browser's 1.28 halved), so the ship coasts twice as far when the throttle is cut | `Assets/Scripts/Ship.cs` (`dragK`) | changed from the browser |
